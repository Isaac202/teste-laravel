            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        <a href="cadastrar" class="small-box-footer">Adcionar Usuario <i class="fas fa-plus"></i></a>
                    </div>
                </div>
            </div>
        @endcan
                            ...
                            <tbody>
                                @foreach ($users as $item)
                                    <tr>
                                        ...
                                        @endcan
                                        <td><a href="edite/{{$item->id }}">Editar</a></td>
                                        <td><a href="/edite/delete/{{$item->id }}">Apagar</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
